      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-10 w-full max-w-md">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-medium text-gray-500 tracking-wide">Full name</label>
            <input 
            type="text" 
        ...
        <p className="text-xs text-gray-400 text-center mt-5">
          Already have an account? <span onClick={() => navigate('/login')} className="text-gray-900 font-medium cursor-pointer">Sign in</span>
        </p>
      </div>
    </form>
  )
